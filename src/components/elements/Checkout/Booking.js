            ...
            <Fade delay={300}>
              <div className="card">
                <figure className="img-wrapper" style={{ height: 270 }}>
                  <img src={`${process.env.REACT_APP_API}/${ItemDetails.imageId[0].imageUrl}`} alt={ItemDetails.title} className="img-cover" />
                </figure>
                <div className="row align-items-center">
                  <div className="col">
                    <div className="meta-wrapper">
                      <h5 style={{ color: "#152C5B" }}>{ItemDetails.title}</h5>
                  ...
                  <div className="col-auto">
                    <span>${Number(checkout.duration * ItemDetails.price)} USD
                      <span className="text-gray-500"> per </span>
                      {checkout.duration} {ItemDetails.unit}
                      {Number(checkout.duration) > 1 ? "s" : ""}
                    </span>
                  </div>
                </div>
              </div>
