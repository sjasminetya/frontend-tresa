      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-3">
            ...
            <ul className="list-group list-group-flush">
              <li className="list-group-item">
                <Button isExternal type="link" href="mailto:dev.shaula@gmail.com">
                  dev.shaula@gmail.com
                </Button>
              </li>
              <li className="list-group-item">
        ...
        <div className="row">
          <div className="col text-center copyrights">
            Copyright {new Date().getFullYear()} • All rights reserved • Tresa
          </div>
        </div>
      </div>
    </footer>
